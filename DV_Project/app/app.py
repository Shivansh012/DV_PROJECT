...
rf_model = pickle.load(open('random_forest_regression_model.pkl','rb'))
...
def main():
    ...
    if option == 'About':
        ...
        html_temp_contact = """
                    ...
                    <div style = "background color:#D7C49EFF; padding:10px">
                    <p>This Model is Developed by <b>Shivansh Goyal</b></p>
                    <p>Gmail: shivansh.goyal2019@vitstudent.ac.in</p>
                    </div>"""
    ...
    html_temp_end = """
        ...
        <h3 style="color:#C7D3D4FF;text-align:center;" >Developed By: <b>Shivansh and Daman</b> </h3>
        </div>
        """
